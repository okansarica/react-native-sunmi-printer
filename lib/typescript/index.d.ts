export declare enum PrinterStyleKey {
...
export declare enum PrinterStyleValue {
    ENABLE = 1,
    DISABLE = 2
}
...
export declare const SunmiScan: SunmiScanType;
declare const _default: SunmiPrinterType;
